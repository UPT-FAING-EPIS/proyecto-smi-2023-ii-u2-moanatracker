...
namespace Moana.View
{
    ...
    {
        public ICommand RecetasCommand { get; private set; }
        ...
        {
            await Application.Current.MainPage.Navigation.PushAsync(new ListadoRecetas());
        }
